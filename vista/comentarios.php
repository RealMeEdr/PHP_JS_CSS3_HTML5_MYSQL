...
<body>
    <header class="header" id="inicio">
        ...
        <form action="../controlador/añadir_comentario.php" method="POST" class="formulario">
                   <h1>Comentario</h1>
                   <div class="linea"></div>
                    ...
                    <div class="">
                        ...
                        <textarea required placeholder="ingresa comentarios aquí" name="comentario" cols="48" rows="10"></textarea>
                    </div>
